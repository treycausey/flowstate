...
export default function Logo({ size = 24, color = 'var(--accent)', title = 'Flowstate' }: Props) {
  ...
  return (
    ...
    >
      ...
      <path d="M3 10c2 0 3-3 6-3s4 3 7 3 4-3 5-3" fill="none" stroke="url(#fs-g)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M3 14c2 0 3-3 6-3s4 3 7 3 4-3 5-3" fill="none" stroke="url(#fs-g)" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  )
}
